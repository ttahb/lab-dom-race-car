class Game {
    ...
    gameLoop(){
        ...
        window.requestAnimationFrame(()=> this.gameLoop())   // used to improve/better manage game animation
        // this.gameLoop() //recursive function to this.gameLoop()
    }

    update(){
        // Return the new position of the car to update the game
        this.player.move();
        // Return the new positions of the obstacles to update th game
